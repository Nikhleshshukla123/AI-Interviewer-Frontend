...
const InterviewInterface = () => {
  ...
  const handleRoleSelect = (role: string) => {
    ...
    const firstQuestion = {
      role: "assistant",
      content: roleQuestions[role as keyof typeof roleQuestions] || "Can you tell me about yourself and your professional background?"
    };
  ...
  const handleSendMessage = () => {
    ...
    setTimeout(() => {
      ...
      const roleResponses = aiResponses[selectedRole as keyof typeof aiResponses] || [
